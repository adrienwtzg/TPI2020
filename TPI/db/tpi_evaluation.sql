...
--
-- Hôte : 127.0.0.1
-- Généré le :  lun. 08 juin 2020 à 21:20
...
(2, 'PRO-VELO', 'Site d&#39;itinéraire de vélo...', 'GE-Roule', '1', '2020-05-25', 1, 2),
(3, 'GE-soif', 'Localise les fontaines autour de l\'utilisateur à Genève.', 'CFPT', '2', '2020-05-25', 1, 2),
(4, 'Pointeuse', 'Permet de controler la présence des élèves aux cours', 'CFPT', '1', '2021-05-30', 1, 3),
...
--
ALTER TABLE `criteres`
  MODIFY `idCritere` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
-- AUTO_INCREMENT pour la table `domaines`
--
ALTER TABLE `domaines`
  MODIFY `idDomaine` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `evaluations`
  MODIFY `idEvaluation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
--
-- AUTO_INCREMENT pour la table `projets`
--
ALTER TABLE `projets`
  MODIFY `idProjet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
--
-- AUTO_INCREMENT pour la table `utilisateurs`
--
ALTER TABLE `utilisateurs`
  MODIFY `idUtilisateur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;COMMIT;
