...
foreach (getElevesProjet($projet["idProjet"]) as $eleve) {
  if ($eleve["idUtilisateur"] == $_SESSION["id"]) {
    ...
    echo "<a href=\"#\" style=\"padding-top: 20px; padding-bottom: 20px;\" class=\"list-group-item list-group-item-action\"><b>(moi)</b> ".$eleve["prenom"]."  ".$eleve["nom"]."</a>";
  }
  else {
    echo "<a href=\"#\" style=\"padding-top: 20px; padding-bottom: 20px;\" class=\"list-group-item list-group-item-action\">".$eleve["prenom"]."  ".$eleve["nom"]."</a>";
  }
